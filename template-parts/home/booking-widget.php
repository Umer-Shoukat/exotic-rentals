		...
		<form class="booking-widget__form" action="<?php echo esc_url(home_url('/reservation/')); ?>" method="get">
			...
			<div class="booking-widget__row">
				...
				<div class="field booking-widget__field">
					...
					<div class="field__control-wrap"><input class="field__control" type="text" id="pickup-time" name="pickup_time" data-time-picker autocomplete="off"><?php echelon_icon('clock'); ?></div>
				</div>
				<div class="field booking-widget__field">
					<label class="field__label" for="return-time"><?php esc_html_e('Return Time', 'echelon'); ?></label>
					<div class="field__control-wrap"><input class="field__control" type="text" id="return-time" name="return_time" data-time-picker autocomplete="off"><?php echelon_icon('clock'); ?></div>
				</div>
				<div class="field booking-widget__field">
